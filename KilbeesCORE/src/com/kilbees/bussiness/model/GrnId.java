...
/**
 * GrnId generated by hbm2java
 */
@Embeddable
public class GrnId implements java.io.Serializable {
	...
	public GrnId(String phUnitNo, String grnNo) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof GrnId))
			return false;
		GrnId castOther = (GrnId) other;
