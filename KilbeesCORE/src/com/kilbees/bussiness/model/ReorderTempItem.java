...
/**
 * ReorderTempItem generated by hbm2java
 */
@Entity
@Table(name = "REORDER_TEMP_ITEM")
public class ReorderTempItem implements java.io.Serializable {

	private ReorderTempItemId id;
	...
	public ReorderTempItem() {
	}

	public ReorderTempItem(ReorderTempItemId id, PharmacyUnit pharmacyUnit,
			double quantity) {
		this.id = id;
	...
	public ReorderTempItem(ReorderTempItemId id, PharmacyUnit pharmacyUnit,
			double quantity, Date orderDate, String userId, String userIp) {
		this.id = id;
		this.pharmacyUnit = pharmacyUnit;
		this.quantity = quantity;
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "reqUnit", column = @Column(name = "REQ_UNIT", nullable = false, length = 20)) })
	public ReorderTempItemId getId() {
		return this.id;
	}

	public void setId(ReorderTempItemId id) {
		this.id = id;
	}
